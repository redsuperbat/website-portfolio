...
<v-container class="main">
  <p :class="{'headline': $vuetify.breakpoint.mdAndUp, 'header':true, 'title': $vuetify.breakpoint.smAndDown} ">{{contactPage.header}}</p>
...
export default {
  ...
  methods: {
    submit: function () {
      window.location.href = 'mailto:max.netterberg@gmail.com?subject=' + this.subject + '&body=' + this.message
    }
  }
}
</script>
